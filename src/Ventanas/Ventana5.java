 ...
 * @author Usuario
 */
public class Ventana5 extends Ventana{
    private static Ventana5 instance = null; 
    Timer timer;
    JLabel base;
    int actual = 0;
    ...
    public static Ventana5 getInstance(){
        if(instance==null)
          instance = new Ventana5();
    ...
    private void crearLabel() {
        JLabel etiqueta = new JLabel (getPalabras(8),SwingConstants.CENTER);
     ...
     private void crearReturn() {
        ...
        retur.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent e){               
                ...
                Ventana5.getInstance().setVisible(false);
            }
        });
        add(retur);
    }
    ...
    private void crearTime() {
        ...
        base = new JLabel(ImageLoader.getInstance().getPersonaje(1)) ;
        ...
        timer = new Timer(100, (ActionEvent ae) -> {
            ...
            ImageIcon nextImage = ImageLoader.getInstance().getPersonaje(actual);
